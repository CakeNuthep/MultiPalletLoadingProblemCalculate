...
namespace MultiPalletLoadingProblemCalculate
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PalletModel pallet1 = new PalletModel(0) { CrossSectionalArea = 20, VolumnMax = 100, WeightMax = 5 };
            PalletModel pallet2 = new PalletModel(1) { CrossSectionalArea = 20, VolumnMax = 80, WeightMax = 10 };
            PalletModel pallet3 = new PalletModel(2) { CrossSectionalArea = 20, VolumnMax = 60, WeightMax = 3 };
            PalletModel pallet4 = new PalletModel(3) { CrossSectionalArea = 10, VolumnMax = 80, WeightMax = 4 };
